...
class Pedido(models.Model):
    usuario = models.ForeignKey(User, on_delete=models.SET_NULL, null=True)
    metodo_pagamento = models.CharField(max_length=200, null=True, blank=True)
    ...
    preco_total = models.DecimalField(max_digits=7, decimal_places=2, null=True, blank=True)
